...
func (*PlayerInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_c61165195dfdc074, []int{0}
}
...
func init() {
	proto.RegisterType((*PlayerInfo)(nil), "alice.checkers.v1.PlayerInfo")
}

func init() { proto.RegisterFile("alice/checkers/v1/player.proto", fileDescriptor_c61165195dfdc074) }

var fileDescriptor_c61165195dfdc074 = []byte{
	// 204 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0x4b, 0xcc, 0xc9, 0x4c,
	0x4e, 0xd5, 0x4f, 0xce, 0x48, 0x4d, 0xce, 0x4e, 0x2d, 0x2a, 0xd6, 0x2f, 0x33, 0xd4, 0x2f, 0xc8,
	0x49, 0xac, 0x4c, 0x2d, 0xd2, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x12, 0x04, 0xcb, 0xeb, 0xc1,
	0xe4, 0xf5, 0xca, 0x0c, 0x95, 0x5a, 0x18, 0xb9, 0xb8, 0x02, 0xc0, 0x6a, 0x3c, 0xf3, 0xd2, 0xf2,
	...
	0xa4, 0xa6, 0x40, 0x94, 0xb0, 0x80, 0x95, 0xa0, 0x89, 0x3a, 0x59, 0x9e, 0x78, 0x24, 0xc7, 0x78,
	0xe1, 0x91, 0x1c, 0xe3, 0x83, 0x47, 0x72, 0x8c, 0x13, 0x1e, 0xcb, 0x31, 0x5c, 0x78, 0x2c, 0xc7,
	0x70, 0xe3, 0xb1, 0x1c, 0x43, 0x94, 0x7c, 0x7a, 0x66, 0x49, 0x46, 0x69, 0x92, 0x5e, 0x72, 0x7e,
	0xae, 0x3e, 0x9a, 0xf7, 0x8a, 0x4a, 0x73, 0x52, 0x8b, 0x93, 0xd8, 0xc0, 0x7e, 0x33, 0x06, 0x04,
	0x00, 0x00, 0xff, 0xff, 0xba, 0x6a, 0x81, 0x1d, 0xfd, 0x00, 0x00, 0x00,
}
...
func (m *PlayerInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ForfeitedCount != 0 {
		i = encodeVarintPlayer(dAtA, i, uint64(m.ForfeitedCount))
		i--
		dAtA[i] = 0x20
	}
	if m.LostCount != 0 {
		i = encodeVarintPlayer(dAtA, i, uint64(m.LostCount))
		i--
		dAtA[i] = 0x18
	}
	if m.WonCount != 0 {
		i = encodeVarintPlayer(dAtA, i, uint64(m.WonCount))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Index) > 0 {
...
func (m *PlayerInfo) Size() (n int) {
	...
	if m.WonCount != 0 {
		n += 1 + sovPlayer(uint64(m.WonCount))
	}
	if m.LostCount != 0 {
		n += 1 + sovPlayer(uint64(m.LostCount))
	}
	if m.ForfeitedCount != 0 {
		n += 1 + sovPlayer(uint64(m.ForfeitedCount))
	}
	return n
}
